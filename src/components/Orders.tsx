...
const Orders = () => {
  ...
  const [ordersSnapshot, loading] = useCollection(
    session && query(collection(db, "users", session?.user?.email as string, "orders"))
  );
      ...
      {loading ? (
        ...
        <div className="flex flex-col gap-5">
          {orders && orders.length > 0 ? (
                ...
                >
                  ...
                  <CardContent>
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                      ...
                      <div>
                        <p className="text-sm font-medium text-black/60">Payment Status</p>
            ...
            <div>
              <p className="text-lg font-medium -mt-3">Your order data is empty.</p>
            </div>
          )}
        </div>
      )}
