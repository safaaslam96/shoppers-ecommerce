...
const SuccessContainer = ({ id }: Props) => {
  ...
  }, [session?.user, cart, handleSaveOrder])

  return (
    <div>
      {loading ? (
        <Loader title="Payment is processing... Please do not press the back button" />
      ) : (
        <div className="bg-gradient-to-b from-green-50 to-white flex items-center justify-center px-4 py-28">
          <div className="max-w-md w-full space-y-8 text-center">
            ...
            <p className="mt-2 text-sm text-gray-600">Your action has been completed successfully.</p>
            <div className="mt-8 space-y-6">
              <p className="text-base text-gray-700">
                Thank you for your submission. We&apos;ve received your information and will process it shortly. You
